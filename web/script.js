(function() {
  ...
  MESSAGES.push({
    delay: 1200,
    text: "I will never leave you my Love ❤️❤️❤️"
  });

  MESSAGES.push({
    delay: 2200,
    text: "All I want and all I need is only you 🫂👀"
  });

  MESSAGES.push({
    delay: 3200,
    text: "I get jealous because...."
  });
  
  MESSAGES.push({
    delay: 4200,
    text: "You are mine only mine, no one can steal you from me 🔐💝"
  });
  ...
  MESSAGES.push({
    delay: 6200,
    text: "You are much more important for me than you think 😣❤️"
  });
  ...
  MESSAGES.push({
    delay: 9200,
    text: "You are my heart, my soul, my treasure, my today,"
  });
  
  MESSAGES.push({
    delay: 10200,
    text: "my tomorrow, My forever and My Everything 🤝💖"
  });
  
  MESSAGES.push({
    delay: 11200,
    text: "You don't need to pretend that you are okay 😫"
  });
  
  MESSAGES.push({
    delay: 12200,
    text: "Cuz deep down in my heart I know how hurt you are 🥺❤️‍🩹"
  });
  
  MESSAGES.push({
    delay: 13200,
    text: "I promise to always be there for you 🫂💞"
  });
  
  MESSAGES.push({
    delay: 14200,
    text: "I can't afford to lose you at any cost 💴👭"
  });
  
  MESSAGES.push({
    delay: 15200,
    text: "No one can replace your place in my heart 🤍😌"
  });
  
  MESSAGES.push({
    delay: 16200,
    text: "I'm far from you but you are the only one I have 🤧❤️"
  });
  
  MESSAGES.push({
    delay: 17200,
    text: "I love you, So whatever you do.... Don't ever go away!!"
  });

  MESSAGES.push({
    delay: 18200,
    text: "I love you.❤️❤️❤️"
  });
  ...
  MESSAGES.push({
    delay: 20200,
    text: "I can do anything for you my Cutie...🥺"
  });
  
  MESSAGES.push({
    delay: 20200,
    text: "Be with me always and forever...🩷"
  });
